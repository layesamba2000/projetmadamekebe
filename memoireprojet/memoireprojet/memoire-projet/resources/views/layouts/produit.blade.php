    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link dropdown-toggle"  id="navbarDropdown" role="button" href="{{asset('produit')}}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Gerer les produits</a>
